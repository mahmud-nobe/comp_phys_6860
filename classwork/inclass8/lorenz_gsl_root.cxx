...
using the GSL and ROOT for a 3d histogram
*/
...
int main (void) {
  ...
  TH3D *hlorenz3d=new TH3D("hlorenz3d","",100,-25,25,100,-25,25,100,0,50);
  ...
  gsl_odeiv2_driver * drv =
      gsl_odeiv2_driver_alloc_y_new (&ode_system, gsl_odeiv2_step_rk4, 
	     h, eps_abs, eps_rel);

  // Runge–Kutta–Fehlberg (4, 5) method: gsl_odeiv2_step_rkf45
  // 4th order Runge–Kutta : gsl_odeiv2_step_rk4
